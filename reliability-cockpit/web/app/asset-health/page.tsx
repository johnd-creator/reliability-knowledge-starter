...
export default function AssetHealthPage() {
  ...
  return <>
    ...
    <SectionCard className="data-section"><div className="section-heading"><div><p className="eyebrow">Reliability Mart / Asset Health</p><h2>{page?.meta.total.toLocaleString("id-ID") ?? "—"} assessments</h2></div>{page && <span className="dataset-badge compact">Factual records</span>}</div>
