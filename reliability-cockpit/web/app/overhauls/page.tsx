...
export default function OverhaulsPage() {
  ...
  return <>
    ...
    <SectionCard className="data-section"><div className="section-heading"><div><p className="eyebrow">Reliability Mart / overhaul_event</p><h2>{page?.meta.total.toLocaleString("id-ID") ?? "—"} overhauls</h2></div>{page && <span className="dataset-badge compact">Contract v1</span>}</div>
