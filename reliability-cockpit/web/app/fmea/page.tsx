...
export default function FmeaPage() {
  ...
  return <>
    ...
    <SectionCard className="data-section"><div className="section-heading"><div><p className="eyebrow">Reliability Mart / FMEA</p><h2>{page?.meta.total.toLocaleString("id-ID") ?? "—"} assessments</h2></div>{page && <span className="dataset-badge compact">Factual records</span>}</div>
