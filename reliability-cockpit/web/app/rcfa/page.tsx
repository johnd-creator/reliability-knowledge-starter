...
export default function RcfaPage() {
  ...
  return <>
    ...
    <SectionCard className="data-section"><div className="section-heading"><div><p className="eyebrow">Reliability Mart / RCFA</p><h2>{page?.meta.total.toLocaleString("id-ID") ?? "—"} analyses</h2></div>{page && <span className="dataset-badge compact">Relationship-safe</span>}</div>
