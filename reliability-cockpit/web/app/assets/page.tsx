...
export default function AssetsPage() {
  ...
  return <>
    ...
    <SectionCard className="data-section"><div className="section-heading"><div><p className="eyebrow">Reliability Mart / Assets</p><h2>{page?.meta.total.toLocaleString("id-ID") ?? "—"} assets</h2></div>{page && <span className="dataset-badge compact">Canonical Contract v1</span>}</div>
