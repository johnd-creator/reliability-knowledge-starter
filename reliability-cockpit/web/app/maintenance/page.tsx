...
export default function MaintenancePage() {
  ...
  return <>
    ...
    <SectionCard className="data-section"><div className="section-heading"><div><p className="eyebrow">Reliability Mart / maintenance_event</p><h2>{page?.meta.total.toLocaleString("id-ID") ?? "—"} maintenance events</h2></div>{page && <span className="dataset-badge compact">Canonical Contract v1</span>}</div>
